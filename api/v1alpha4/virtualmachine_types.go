...
type VirtualMachineSpec struct {
	...
	// +optional
	// +kubebuilder:default=Linked

	// DeployMode describes the mode in which the VM is deployed. The available
	// modes are:
	//
	// - Direct              -- a full clone of the VM image
	// - Linked              -- a linked clone of the VM image
	//
	// Defaults to Linked.
	// DeployMode VirtualMachineDeployMode `json:"deployMode,omitempty"`
...
type VirtualMachineStatus struct {
	...
	// TaskID describes the ID of a task created by VM Operator to modify this
	// VM in some way.
